...
<section id="course_all" class="padding-bottom-half padding-top">
  <div class="container">
    <div class="row">
	    <div class="col-sm-8 course_detail wow fadeIn animated animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeIn;">
      ...
      <!-- aside -->
	    ...
	    <?=$this->load->view('elements/modules/module_hotline')?>
                
        <?=$this->load->view('elements/modules/module_news_categories',array('categories'=>$other_categories))?>
        
        <?=$this->load->view('elements/modules/module_solutions')?>
        
        <?=$this->load->view('elements/modules/module_worktime')?>
