...
<div class="container">
	<div class="row">
		...
		<div class="col-right col-sm-9 col-md-9">
			...
			<form class="form-horizontal" action="<?=site_url('admin/modules/banners/edit/'.$item->id)?>" id='main_form_submit'  method="post">
				...
				<div class='form-group'>
				 ...
				 <div class="form-group">
					 ...
					 <div class='col-sm-9'>
						<?php
							echo form_input('title',$item->translations ? set_value('title',$item->translations[0]->title):"",'class="form-control"');
						?>
					 </div>
	            </div>
					 ...
					 <div class='col-sm-9'>
						 <?php
							 if(isset($item->translations[0])):
							 	if(!empty($item->translations[0]->image)):
							 ?>
							 <p style="padding-bottom:10px;">
							<img src='<?=base_url()?>assets/upload/img/thumbnail/<?=$item->translations[0]->image?>' />
						</p>
						<?php
								endif;
							 endif;
			     	 	...
			     	 	<?php	
			    			$this->load->view('admin/elements/fileupload_view.php',array('file'=>'image','id'=>'Banner_image','value'=>
			    			$item->translations[0]->image,'multiple'=>false));
			    		?>
					 </div>
	            </div>
	            ...
	            <div class='form-group'>
		            <label class="control-label col-sm-2" for="description">Description</label>
					 <div class='col-sm-9'>
						<textarea class="form-control" id="description" name="description"><?php echo $item->translations ? set_value('description',$item->translations[0]->description):""?>
						</textarea>
					 </div>
	            </div>
