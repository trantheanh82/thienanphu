				...
				<table class="table table-hover table-bordered table-condensed">
					...
					<?php
						...
						<tr>
							...
							<td><a href='<?=base_url()?>admin/modules/testimonials/edit/<?=$item->id?>'><i class="glyphicon glyphicon-edit"></i></a> <a id='<?=$item->id?>' class='delete' data-delete-link='<?=base_url()?>admin/modules/testimonials/delete/<?=$item->id?>' data-toggle="modal" data-target="#myModal" data-title='confirm delete'><i class='glyphicon glyphicon-remove'></i></a></td>
						</tr>
					<?php
						endforeach;
					?>
